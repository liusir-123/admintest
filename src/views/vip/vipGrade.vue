  ...
  <div class="content-transparent paddingAll">
    ...
    <div class="wplane paddingAll0">
      <div class="tabInfoTitle flex_rowBetwen">
        <h6>数据列表</h6>
        <span>
          <el-button type="primary" @click="dialogVisible = true" plain icon="el-icon-plus" size="mini"> 新增等级</el-button>
        </span>
      </div>
      <div class="padding_left padding_right padding_b padding_t">
        <template>
          <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="name" label="等级ID">
            </el-table-column>
            <el-table-column prop="name" label="等级名称">
            </el-table-column>
            <el-table-column prop="name" label="等级折扣">
            </el-table-column>
            <el-table-column prop="name" label="分销">
